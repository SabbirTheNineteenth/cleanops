      ...
      >
        <div className="flex items-center gap-3 px-5 py-6">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-[11px] uppercase tracking-[0.2em] text-ink-500">Operational command</p>
          </div>
          <button
            type="button"
            aria-label="Close navigation menu"
        ...
        <div className="mx-3 mb-1 flex items-center justify-between rounded-xl border border-white/5 bg-white/[0.03] px-3 py-2 md:hidden">
          <span className="text-xs font-medium text-ink-400">Appearance</span>
          <ThemeToggle />
        </div>
